...
<section class="support-section" id="support">
  <div class="support-wrapper">
    <div class="support-layout">
      ...
      <form class="form-card reveal reveal-d2" id="contact-form" method="post" action="#">
        <div class="form-head">
          <p class="section-kicker">форма заявки</p>
        ...
        <div class="form-grid">
          <div class="field">
            ...
            <select>
              ...
              <option>CRM для бизнеса</option>
              <option>Telegram бот</option>
              <option>Программа для ресторана</option>
              <option>Бухгалтерия и учет</option>
              <option>NFC карты</option>
              <option>Программа для клиники</option>
              <option>Программа для аптеки</option>
              <option>Специальный заказ</option>
            </select>
          </div>
          <div class="field">
            <label>Имя</label>
          ...
          <div class="field">
            ...
            <input type="text" placeholder="Ресторан, клиника, аптека, магазин...">
          </div>
          <div class="field">
...
<label>Проект</label>
            <select>
              ...
              <option>Telegram бот</option>
              <option>Веб программа</option>
              <option>Готовое решение</option>
          ...
          <div class="field">
            ...
            <select>
              ...
              <option>Учет клиентов</option>
              <option>Онлайн заказы</option>
              <option>Склад и товары</option>
              <option>Финансовый учет</option>
              <option>Удобное управление</option>
            </select>
          </div>
          <div class="field">
          ...
          <div class="field">
            <label>Бюджет</label>
            <input type="text" placeholder="Например: от 300$">
          </div>
        ...
        <div class="field" style="margin-bottom: 16px;">
          ...
          <textarea rows="5" placeholder="Опишите ваш бизнес, текущую ситуацию и нужный результат."></textarea>
        </div>
        <div class="field" style="margin-bottom: 28px;">
          <label>Дополнительное сообщение</label>
          <textarea rows="3" placeholder="Необязательно"></textarea>
        </div>

        <div class="form-success" id="formSuccess" style="display:none;">Ваша заявка принята. Мы скоро свяжемся с вами.</div>
...
(function () {
  function initMirsaarLanding() {
    ...
    // Form fake success for static landing page
    const form = root.querySelector('#contact-form');
    if (form && !form.dataset.ready) {
      form.dataset.ready = '1';
      form.addEventListener('submit', function (e) {
        e.preventDefault();
        const msg = root.querySelector('#formSuccess');
        if (msg) {
